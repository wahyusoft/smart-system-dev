...
procedure TfrmPurchase.btnBaruClick(Sender: TObject);
begin
  frmAddPurchase := TfrmAddPurchase.Create(Application);
  try
    frmAddPurchase.panelfrmkelompok.Caption := 'Tambah Purchase Order';
    frmAddPurchase.ShowModal;
  finally
    frmAddPurchase.Free;
  end;
end;

procedure TfrmPurchase.Button1Click(Sender: TObject);
begin
