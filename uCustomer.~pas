...
begin
  frmAddCustomer := TfrmAddCustomer.Create(Application);
  try
    frmAddCustomer.panelfrmkelompok.Caption := 'Tambah Customer';
...
begin
    frmAddCustomer := TfrmAddCustomer.Create(Application);
  try
    frmAddCustomer.panelfrmkelompok.Caption := 'Edit Customer';
    frmAddCustomer.ShowModal;
  finally
    frmAddCustomer.Free;
  end;
