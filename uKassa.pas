...
begin
  frmAddKassa := TfrmAddKassa.Create(Application);
  try
    frmAddKassa.panelfrmkelompok.Caption := 'Tambah Kassa';
    frmAddKassa.ShowModal;
  finally
    frmAddKassa.Free;
  end;
...
begin
    frmAddKassa := TfrmAddKassa.Create(Application);
  try
    frmAddKassa.panelfrmkelompok.Caption := 'Edit Kassa';
    frmAddKassa.ShowModal;
  finally
    frmAddKassa.Free;
  end;
